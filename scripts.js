document.addEventListener('DOMContentLoaded', () => {
  ...
  const forms = [
    { formId: 'formCash', usdInputId: 'usdCash', rateId: 'rateCash', effId: 'effCash', zarId: 'zarCash', method: 'Cash', 
      ...
      senderNameId: 'senderFullNameCash', senderEmailId: 'senderEmailCash', senderMobileId: 'senderMobileCash', extraId: 'pickupLocationCash' },
  ...
  // Validate ID or extra fields (real-time)
  ...
  const setupForm = ({ formId, usdInputId, rateId, effId, zarId, method, beneficiaryNameId, beneficiaryMobileId, beneficiaryIdId, senderNameId, senderEmailId, senderMobileId, extraId, extraIds }) => {
    ...
    if (extraInput) extraInput.addEventListener('input', () => validateExtra(extraInput, method === 'Mobile' ? 'Wallet required' : 'Bank required'));
    ...
    form.addEventListener('submit', (e) => {
      ...
      if (extraInput) isValid = validateExtra(extraInput, method === 'Mobile' ? 'Wallet required' : 'Bank required') && isValid;
